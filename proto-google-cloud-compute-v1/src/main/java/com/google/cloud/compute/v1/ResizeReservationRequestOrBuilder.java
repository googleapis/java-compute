...
public interface ResizeReservationRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.ResizeReservationRequest)
   ...
   *
   * <code>
   * .google.cloud.compute.v1.ReservationsResizeRequest reservations_resize_request_resource = 389262801 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
