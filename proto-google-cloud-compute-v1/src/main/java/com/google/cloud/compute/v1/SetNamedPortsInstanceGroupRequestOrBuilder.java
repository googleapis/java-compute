...
public interface SetNamedPortsInstanceGroupRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.SetNamedPortsInstanceGroupRequest)
   ...
   */
  boolean hasInstanceGroupsSetNamedPortsRequestResource();
  /**
   *
   *
   * <pre>
