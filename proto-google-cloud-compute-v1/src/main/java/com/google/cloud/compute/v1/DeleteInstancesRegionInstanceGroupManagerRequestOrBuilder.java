...
public interface DeleteInstancesRegionInstanceGroupManagerRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.DeleteInstancesRegionInstanceGroupManagerRequest)
   ...
   */
  boolean hasRegionInstanceGroupManagersDeleteInstancesRequestResource();
  /**
   *
   *
   * <pre>
