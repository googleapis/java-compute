...
public class ReservationsClientTest {
  private static MockHttpService mockService;
  private static ReservationsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonReservationsStub.getMethodDescriptors(),
            ReservationsSettings.getDefaultEndpoint());
    ReservationsSettings settings =
        ReservationsSettings.newBuilder()
            .setTransportChannelProvider(
                ReservationsSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void aggregatedListTest() throws Exception {
    ReservationsScopedList responsesElement = ReservationsScopedList.newBuilder().build();
    ...
    List<Map.Entry<String, ReservationsScopedList>> resources =
  ...
  public void updateTest() throws Exception {
    ...
    Operation actualResponse =
        client.updateAsync(project, zone, reservation, reservationResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
