...
public class ITSecurityPolicies {
    ...
    public void testCreateGetDelete() throws IOException, ExecutionException, InterruptedException {
        ...
        SecurityPolicyRuleMatcher securityPolicyRuleMatcher = SecurityPolicyRuleMatcher.newBuilder()
                .setVersionedExpr(SecurityPolicyRuleMatcher.VersionedExpr.SRC_IPS_V1.toString())
                .setConfig(SecurityPolicyRuleMatcherConfig.newBuilder()
                        .addSrcIpRanges("*")
                        .build()).build();
        SecurityPolicyRule securityPolicyRule = SecurityPolicyRule.newBuilder()
                .setAction("allow")
                .setPriority(0)
                .setDescription("test rule")
                .setMatch(securityPolicyRuleMatcher)
                .build();
        SecurityPolicyRule securityPolicyRuleDefault =  SecurityPolicyRule.newBuilder()
                .setAction("allow")
                .setPriority(2147483647)
                .setDescription("default rule")
                .setMatch(securityPolicyRuleMatcher)
                .build();
        SecurityPolicy securityPolicy = SecurityPolicy.newBuilder()
                .setName(ruleName)
        ...
        try {
            ...
            RemoveRuleSecurityPolicyRequest removeRuleSecurityPolicyRequest = RemoveRuleSecurityPolicyRequest.newBuilder()
                    .setPriority(0)
