...
public class ServiceAttachmentsClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final Operation delete(String project, String region, String serviceAttachment) {
   ...
   *           .build();
   *   Operation response = serviceAttachmentsClient.delete(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final Operation delete(DeleteServiceAttachmentRequest request) {
   ...
   *   Operation response =
   *       serviceAttachmentsClient.insert(project, region, serviceAttachmentResource);
   * }
   * }</pre>
   *
   * @param project Project ID for this request.
   ...
   *           .build();
   *   Operation response = serviceAttachmentsClient.insert(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final Operation insert(InsertServiceAttachmentRequest request) {
   ...
   *           .setServiceAttachmentResource(ServiceAttachment.newBuilder().build())
   *           .build();
   *   Operation response = serviceAttachmentsClient.patch(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final Operation patch(PatchServiceAttachmentRequest request) {
