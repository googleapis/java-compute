...
public class ForwardingRulesClientTest {
  private static MockHttpService mockService;
  private static ForwardingRulesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonForwardingRulesStub.getMethodDescriptors(),
            ForwardingRulesSettings.getDefaultEndpoint());
    ForwardingRulesSettings settings =
        ForwardingRulesSettings.newBuilder()
            .setTransportChannelProvider(
                ForwardingRulesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = ForwardingRulesClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    ForwardingRulesScopedList responsesElement = ForwardingRulesScopedList.newBuilder().build();
    ...
    List<Map.Entry<String, ForwardingRulesScopedList>> resources =
