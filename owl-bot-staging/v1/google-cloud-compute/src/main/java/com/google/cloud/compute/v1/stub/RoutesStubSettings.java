...
/**
 * Settings class to configure an instance of {@link RoutesStub}.
 *
...
public class RoutesStubSettings extends StubSettings<RoutesStubSettings> {
  ...
  private final UnaryCallSettings<DeleteRouteRequest, Operation> deleteSettings;
  private final OperationCallSettings<DeleteRouteRequest, Operation, Operation>
      deleteOperationSettings;
  private final UnaryCallSettings<GetRouteRequest, Route> getSettings;
  private final UnaryCallSettings<InsertRouteRequest, Operation> insertSettings;
  ...
  private static final PagedListDescriptor<ListRoutesRequest, RouteList, Route> LIST_PAGE_STR_DESC =
      new PagedListDescriptor<ListRoutesRequest, RouteList, Route>() {
        ...
        public ListRoutesRequest injectPageSize(ListRoutesRequest payload, int pageSize) {
          return ListRoutesRequest.newBuilder(payload).setMaxResults(pageSize).build();
        }
  ...
  private static final PagedListResponseFactory<ListRoutesRequest, RouteList, ListPagedResponse>
      LIST_PAGE_STR_FACT =
          new PagedListResponseFactory<ListRoutesRequest, RouteList, ListPagedResponse>() {
            @Override
            public ApiFuture<ListPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListRoutesRequest, RouteList> callable,
                ListRoutesRequest request,
                ApiCallContext context,
                ApiFuture<RouteList> futureResponse) {
              PageContext<ListRoutesRequest, RouteList, Route> pageContext =
  ...
  public RoutesStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonRoutesStub.create(this);
    }
  ...
  protected RoutesStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<RoutesStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<DeleteRouteRequest, Operation> deleteSettings;
    private final OperationCallSettings.Builder<DeleteRouteRequest, Operation, Operation>
        deleteOperationSettings;
    private final UnaryCallSettings.Builder<GetRouteRequest, Route> getSettings;
    private final UnaryCallSettings.Builder<InsertRouteRequest, Operation> insertSettings;
    private final OperationCallSettings.Builder<InsertRouteRequest, Operation, Operation>
        insertOperationSettings;
    ...
    protected Builder(RoutesStubSettings settings) {
      super(settings);
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          .insertOperationSettings()
          .setInitialCallSettings(
              UnaryCallSettings.<InsertRouteRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
    ...
    @Override
    public RoutesStubSettings build() throws IOException {
      return new RoutesStubSettings(this);
    }
  }
}
