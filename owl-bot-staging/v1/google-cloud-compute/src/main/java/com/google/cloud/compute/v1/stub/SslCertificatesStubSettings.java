...
public class SslCertificatesStubSettings extends StubSettings<SslCertificatesStubSettings> {
  ...
  private final OperationCallSettings<DeleteSslCertificateRequest, Operation, Operation>
  ...
  private final OperationCallSettings<InsertSslCertificateRequest, Operation, Operation>
  ...
  public static class Builder extends StubSettings.Builder<SslCertificatesStubSettings, Builder> {
    ...
    private final OperationCallSettings.Builder<DeleteSslCertificateRequest, Operation, Operation>
        deleteOperationSettings;
    ...
    private final OperationCallSettings.Builder<InsertSslCertificateRequest, Operation, Operation>
        insertOperationSettings;
    private final PagedCallSettings.Builder<
            ListSslCertificatesRequest, SslCertificateList, ListPagedResponse>
        listSettings;
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteSslCertificateRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<InsertSslCertificateRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
