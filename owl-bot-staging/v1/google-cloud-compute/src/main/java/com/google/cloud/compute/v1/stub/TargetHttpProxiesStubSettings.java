...
/**
 * Settings class to configure an instance of {@link TargetHttpProxiesStub}.
 *
...
public class TargetHttpProxiesStubSettings extends StubSettings<TargetHttpProxiesStubSettings> {
  ...
  private final OperationCallSettings<DeleteTargetHttpProxyRequest, Operation, Operation>
  ...
  private final OperationCallSettings<InsertTargetHttpProxyRequest, Operation, Operation>
  ...
  private final OperationCallSettings<PatchTargetHttpProxyRequest, Operation, Operation>
      patchOperationSettings;
  private final UnaryCallSettings<SetUrlMapTargetHttpProxyRequest, Operation> setUrlMapSettings;
  private final OperationCallSettings<SetUrlMapTargetHttpProxyRequest, Operation, Operation>
  ...
  private static final PagedListDescriptor<
      ...
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public AggregatedListTargetHttpProxiesRequest injectToken(
                AggregatedListTargetHttpProxiesRequest payload, String token) {
              return AggregatedListTargetHttpProxiesRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public AggregatedListTargetHttpProxiesRequest injectPageSize(
                AggregatedListTargetHttpProxiesRequest payload, int pageSize) {
              return AggregatedListTargetHttpProxiesRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<Map.Entry<String, TargetHttpProxiesScopedList>> extractResources(
                TargetHttpProxyAggregatedList payload) {
              return payload.getItemsMap() == null
                  ? Collections.<Map.Entry<String, TargetHttpProxiesScopedList>>emptySet()
                  : payload.getItemsMap().entrySet();
            }
          };

  private static final PagedListDescriptor<
          ListTargetHttpProxiesRequest, TargetHttpProxyList, TargetHttpProxy>
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
              ListTargetHttpProxiesRequest, TargetHttpProxyList, TargetHttpProxy>() {
            @Override
            ...
            @Override
            public ListTargetHttpProxiesRequest injectToken(
                ListTargetHttpProxiesRequest payload, String token) {
              return ListTargetHttpProxiesRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListTargetHttpProxiesRequest injectPageSize(
                ListTargetHttpProxiesRequest payload, int pageSize) {
              return ListTargetHttpProxiesRequest.newBuilder(payload)
                  .setMaxResults(pageSize)
                  .build();
            }
      ...
      LIST_PAGE_STR_FACT =
          new PagedListResponseFactory<
            ...
            public ApiFuture<ListPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListTargetHttpProxiesRequest, TargetHttpProxyList> callable,
                ListTargetHttpProxiesRequest request,
                ApiCallContext context,
                ApiFuture<TargetHttpProxyList> futureResponse) {
              PageContext<ListTargetHttpProxiesRequest, TargetHttpProxyList, TargetHttpProxy>
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(TargetHttpProxiesStubSettings.class))
        .setTransportToken(
  ...
  public static class Builder extends StubSettings.Builder<TargetHttpProxiesStubSettings, Builder> {
    ...
    private final OperationCallSettings.Builder<DeleteTargetHttpProxyRequest, Operation, Operation>
        deleteOperationSettings;
    ...
    private final OperationCallSettings.Builder<InsertTargetHttpProxyRequest, Operation, Operation>
        insertOperationSettings;
    private final PagedCallSettings.Builder<
            ListTargetHttpProxiesRequest, TargetHttpProxyList, ListPagedResponse>
        listSettings;
    private final UnaryCallSettings.Builder<PatchTargetHttpProxyRequest, Operation> patchSettings;
    private final OperationCallSettings.Builder<PatchTargetHttpProxyRequest, Operation, Operation>
        patchOperationSettings;
    private final UnaryCallSettings.Builder<SetUrlMapTargetHttpProxyRequest, Operation>
        setUrlMapSettings;
    private final OperationCallSettings.Builder<
            SetUrlMapTargetHttpProxyRequest, Operation, Operation>
        setUrlMapOperationSettings;
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteTargetHttpProxyRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<InsertTargetHttpProxyRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<PatchTargetHttpProxyRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<SetUrlMapTargetHttpProxyRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
