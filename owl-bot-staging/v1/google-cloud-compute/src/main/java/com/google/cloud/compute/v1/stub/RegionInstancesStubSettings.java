...
/**
 * Settings class to configure an instance of {@link RegionInstancesStub}.
 *
...
public class RegionInstancesStubSettings extends StubSettings<RegionInstancesStubSettings> {
  ...
  public RegionInstancesStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonRegionInstancesStub.create(this);
    }
  ...
  protected RegionInstancesStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<RegionInstancesStubSettings, Builder> {
    ...
    protected Builder(RegionInstancesStubSettings settings) {
      super(settings);
    ...
    @Override
    public RegionInstancesStubSettings build() throws IOException {
      return new RegionInstancesStubSettings(this);
    }
  }
}
