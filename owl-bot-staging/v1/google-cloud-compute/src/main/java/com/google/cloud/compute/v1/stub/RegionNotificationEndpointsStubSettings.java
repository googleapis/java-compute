...
/**
 * Settings class to configure an instance of {@link RegionNotificationEndpointsStub}.
 *
...
public class RegionNotificationEndpointsStubSettings
    extends StubSettings<RegionNotificationEndpointsStubSettings> {
  ...
  private final UnaryCallSettings<GetRegionNotificationEndpointRequest, NotificationEndpoint>
      getSettings;
  private final UnaryCallSettings<InsertRegionNotificationEndpointRequest, Operation>
      insertSettings;
  private final OperationCallSettings<InsertRegionNotificationEndpointRequest, Operation, Operation>
  ...
  private static final PagedListDescriptor<
      ...
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListRegionNotificationEndpointsRequest injectToken(
                ListRegionNotificationEndpointsRequest payload, String token) {
              return ListRegionNotificationEndpointsRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListRegionNotificationEndpointsRequest injectPageSize(
                ListRegionNotificationEndpointsRequest payload, int pageSize) {
              return ListRegionNotificationEndpointsRequest.newBuilder(payload)
            ...
            @Override
            public Integer extractPageSize(ListRegionNotificationEndpointsRequest payload) {
            ...
            @Override
            public Iterable<NotificationEndpoint> extractResources(
                NotificationEndpointList payload) {
              return payload.getItemsList() == null
                  ? ImmutableList.<NotificationEndpoint>of()
  ...
  public RegionNotificationEndpointsStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonRegionNotificationEndpointsStub.create(this);
    }
  ...
  public static class Builder
    ...
    private final UnaryCallSettings.Builder<
        ...
        getSettings;
    private final UnaryCallSettings.Builder<InsertRegionNotificationEndpointRequest, Operation>
        insertSettings;
    private final OperationCallSettings.Builder<
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteRegionNotificationEndpointRequest, OperationSnapshot>
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<InsertRegionNotificationEndpointRequest, OperationSnapshot>
                      newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
    ...
    @Override
    public RegionNotificationEndpointsStubSettings build() throws IOException {
      return new RegionNotificationEndpointsStubSettings(this);
    }
  }
}
