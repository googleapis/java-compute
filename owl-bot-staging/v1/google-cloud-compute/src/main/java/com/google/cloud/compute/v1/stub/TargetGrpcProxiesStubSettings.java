...
/**
 * Settings class to configure an instance of {@link TargetGrpcProxiesStub}.
 *
...
public class TargetGrpcProxiesStubSettings extends StubSettings<TargetGrpcProxiesStubSettings> {
  ...
  private static final PagedListDescriptor<
      ...
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListTargetGrpcProxiesRequest injectToken(
                ListTargetGrpcProxiesRequest payload, String token) {
              return ListTargetGrpcProxiesRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListTargetGrpcProxiesRequest injectPageSize(
                ListTargetGrpcProxiesRequest payload, int pageSize) {
              return ListTargetGrpcProxiesRequest.newBuilder(payload)
                  .setMaxResults(pageSize)
                  .build();
            }

            @Override
            public Integer extractPageSize(ListTargetGrpcProxiesRequest payload) {
      ...
      LIST_PAGE_STR_FACT =
          new PagedListResponseFactory<
            ...
            public ApiFuture<ListPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListTargetGrpcProxiesRequest, TargetGrpcProxyList> callable,
                ListTargetGrpcProxiesRequest request,
                ApiCallContext context,
                ApiFuture<TargetGrpcProxyList> futureResponse) {
              PageContext<ListTargetGrpcProxiesRequest, TargetGrpcProxyList, TargetGrpcProxy>
  ...
  public TargetGrpcProxiesStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonTargetGrpcProxiesStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(TargetGrpcProxiesStubSettings.class))
        .setTransportToken(
  ...
  protected TargetGrpcProxiesStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<TargetGrpcProxiesStubSettings, Builder> {
    ...
    protected Builder(TargetGrpcProxiesStubSettings settings) {
      super(settings);
    ...
    @Override
    public TargetGrpcProxiesStubSettings build() throws IOException {
      return new TargetGrpcProxiesStubSettings(this);
    }
  }
}
