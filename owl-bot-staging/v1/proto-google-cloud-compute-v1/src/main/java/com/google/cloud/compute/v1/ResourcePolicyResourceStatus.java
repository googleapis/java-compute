      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case -1535950462: {
            com.google.cloud.compute.v1.ResourcePolicyResourceStatusInstanceSchedulePolicyStatus.Builder subBuilder = null;
            if (((bitField0_ & 0x00000001) != 0)) {
              subBuilder = instanceSchedulePolicy_.toBuilder();
            }
            instanceSchedulePolicy_ = input.readMessage(com.google.cloud.compute.v1.ResourcePolicyResourceStatusInstanceSchedulePolicyStatus.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.compute.v1.ResourcePolicyResourceStatus) e.getUnfinishedMessage();
