...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 882012426: {
            ...
            tests_.add(
                input.readMessage(com.google.cloud.compute.v1.UrlMapTest.parser(), extensionRegistry));
            break;
          }
          case 1111570338: {
            java.lang.String s = input.readStringRequireUtf8();
          ...
          case -2121653542: {
            ...
            pathMatchers_.add(
                input.readMessage(com.google.cloud.compute.v1.PathMatcher.parser(), extensionRegistry));
            break;
          }
          case -1800528638: {
            ...
            hostRules_.add(
                input.readMessage(com.google.cloud.compute.v1.HostRule.parser(), extensionRegistry));
            break;
          }
          case -1670348478: {
          ...
          case -1418940590: {
            ...
            defaultUrlRedirect_ = input.readMessage(com.google.cloud.compute.v1.HttpRedirectAction.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case -1263611566: {
            ...
            defaultRouteAction_ = input.readMessage(com.google.cloud.compute.v1.HttpRouteAction.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.cloud.compute.v1.Compute.internal_static_google_cloud_compute_v1_UrlMap_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.cloud.compute.v1.Compute.internal_static_google_cloud_compute_v1_UrlMap_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.compute.v1.UrlMap.class, com.google.cloud.compute.v1.UrlMap.Builder.class);
  }
  ...
  public com.google.cloud.compute.v1.HttpRouteAction getDefaultRouteAction() {
    return defaultRouteAction_ == null ? com.google.cloud.compute.v1.HttpRouteAction.getDefaultInstance() : defaultRouteAction_;
  }
  /**
   * <pre>
   * defaultRouteAction takes effect when none of the hostRules match. The load balancer performs advanced routing actions like URL rewrites, header transformations, etc. prior to forwarding the request to the selected backend. If defaultRouteAction specifies any weightedBackendServices, defaultService must not be set. Conversely if defaultService is set, defaultRouteAction cannot contain any weightedBackendServices. Only one of defaultRouteAction or defaultUrlRedirect must be set. UrlMaps for external HTTP(S) load balancers support only the urlRewrite action within defaultRouteAction. defaultRouteAction has no effect when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
  ...
  public com.google.cloud.compute.v1.HttpRedirectAction getDefaultUrlRedirect() {
    return defaultUrlRedirect_ == null ? com.google.cloud.compute.v1.HttpRedirectAction.getDefaultInstance() : defaultUrlRedirect_;
  }
  /**
   * <pre>
   * When none of the specified hostRules match, the request is redirected to a URL specified by defaultUrlRedirect. If defaultUrlRedirect is specified, defaultService or defaultRouteAction must not be set. Not supported when the URL map is bound to target gRPC proxy.
   ...
   */
  @java.lang.Override
  public com.google.cloud.compute.v1.HostRuleOrBuilder getHostRulesOrBuilder(
      int index) {
    return hostRules_.get(index);
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.compute.v1.PathMatcherOrBuilder getPathMatchersOrBuilder(
      int index) {
    return pathMatchers_.get(index);
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.compute.v1.UrlMapTestOrBuilder getTestsOrBuilder(
      int index) {
    return tests_.get(index);
  }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < tests_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(110251553, tests_.get(i));
    }
    if (((bitField0_ & 0x00000400) != 0)) {
    ...
    for (int i = 0; i < pathMatchers_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(271664219, pathMatchers_.get(i));
    }
    for (int i = 0; i < hostRules_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(311804832, hostRules_.get(i));
    }
    if (((bitField0_ & 0x00000040) != 0)) {
      size += com.google.protobuf.CodedOutputStream
    ...
    if (((bitField0_ & 0x00000008) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(359503338, getDefaultUrlRedirect());
    }
    if (((bitField0_ & 0x00000004) != 0)) {
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(378919466, getDefaultRouteAction());
    }
    if (((bitField0_ & 0x00000010) != 0)) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasDefaultRouteAction()) {
      if (!getDefaultRouteAction()
          .equals(other.getDefaultRouteAction())) return false;
    }
    if (hasDefaultService() != other.hasDefaultService()) return false;
    if (hasDefaultService()) {
      if (!getDefaultService()
          .equals(other.getDefaultService())) return false;
    }
    if (hasDefaultUrlRedirect() != other.hasDefaultUrlRedirect()) return false;
    if (hasDefaultUrlRedirect()) {
      if (!getDefaultUrlRedirect()
          .equals(other.getDefaultUrlRedirect())) return false;
    }
    ...
    if (!getHostRulesList()
        .equals(other.getHostRulesList())) return false;
    ...
    if (!getPathMatchersList()
        .equals(other.getPathMatchersList())) return false;
        ...
        if (!other.pathMatchers_.isEmpty()) {
          if (pathMatchersBuilder_.isEmpty()) {
            ...
            pathMatchersBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getPathMatchersFieldBuilder() : null;
          } else {
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.compute.v1.HttpRouteAction, com.google.cloud.compute.v1.HttpRouteAction.Builder, com.google.cloud.compute.v1.HttpRouteActionOrBuilder> defaultRouteActionBuilder_;
    /**
     * <pre>
     * defaultRouteAction takes effect when none of the hostRules match. The load balancer performs advanced routing actions like URL rewrites, header transformations, etc. prior to forwarding the request to the selected backend. If defaultRouteAction specifies any weightedBackendServices, defaultService must not be set. Conversely if defaultService is set, defaultRouteAction cannot contain any weightedBackendServices. Only one of defaultRouteAction or defaultUrlRedirect must be set. UrlMaps for external HTTP(S) load balancers support only the urlRewrite action within defaultRouteAction. defaultRouteAction has no effect when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
     * </pre>
    ...
    public Builder mergeDefaultRouteAction(com.google.cloud.compute.v1.HttpRouteAction value) {
      if (defaultRouteActionBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
            defaultRouteAction_ != null &&
            defaultRouteAction_ != com.google.cloud.compute.v1.HttpRouteAction.getDefaultInstance()) {
          defaultRouteAction_ =
            com.google.cloud.compute.v1.HttpRouteAction.newBuilder(defaultRouteAction_).mergeFrom(value).buildPartial();
        } else {
          defaultRouteAction_ = value;
        }
        onChanged();
    ...
    public com.google.cloud.compute.v1.HttpRouteActionOrBuilder getDefaultRouteActionOrBuilder() {
      if (defaultRouteActionBuilder_ != null) {
        ...
        return defaultRouteAction_ == null ?
            com.google.cloud.compute.v1.HttpRouteAction.getDefaultInstance() : defaultRouteAction_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ...
        getDefaultRouteActionFieldBuilder() {
      if (defaultRouteActionBuilder_ == null) {
        defaultRouteActionBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.compute.v1.HttpRouteAction, com.google.cloud.compute.v1.HttpRouteAction.Builder, com.google.cloud.compute.v1.HttpRouteActionOrBuilder>(
     ...
     * @return This builder for chaining.
     */
    public Builder setDefaultService(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
  bitField0_ |= 0x00000004;
     ...
     * @return This builder for chaining.
     */
    public Builder setDefaultServiceBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
    ...
    private com.google.cloud.compute.v1.HttpRedirectAction defaultUrlRedirect_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.compute.v1.HttpRedirectAction, com.google.cloud.compute.v1.HttpRedirectAction.Builder, com.google.cloud.compute.v1.HttpRedirectActionOrBuilder> defaultUrlRedirectBuilder_;
    /**
     * <pre>
     * When none of the specified hostRules match, the request is redirected to a URL specified by defaultUrlRedirect. If defaultUrlRedirect is specified, defaultService or defaultRouteAction must not be set. Not supported when the URL map is bound to target gRPC proxy.
     * </pre>
    ...
    public Builder mergeDefaultUrlRedirect(com.google.cloud.compute.v1.HttpRedirectAction value) {
      if (defaultUrlRedirectBuilder_ == null) {
        if (((bitField0_ & 0x00000008) != 0) &&
            defaultUrlRedirect_ != null &&
            defaultUrlRedirect_ != com.google.cloud.compute.v1.HttpRedirectAction.getDefaultInstance()) {
          defaultUrlRedirect_ =
            com.google.cloud.compute.v1.HttpRedirectAction.newBuilder(defaultUrlRedirect_).mergeFrom(value).buildPartial();
        } else {
          defaultUrlRedirect_ = value;
        }
        onChanged();
    ...
    public com.google.cloud.compute.v1.HttpRedirectActionOrBuilder getDefaultUrlRedirectOrBuilder() {
      if (defaultUrlRedirectBuilder_ != null) {
        ...
        return defaultUrlRedirect_ == null ?
            com.google.cloud.compute.v1.HttpRedirectAction.getDefaultInstance() : defaultUrlRedirect_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ...
        getDefaultUrlRedirectFieldBuilder() {
      if (defaultUrlRedirectBuilder_ == null) {
        defaultUrlRedirectBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.compute.v1.HttpRedirectAction, com.google.cloud.compute.v1.HttpRedirectAction.Builder, com.google.cloud.compute.v1.HttpRedirectActionOrBuilder>(
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.HostRule, com.google.cloud.compute.v1.HostRule.Builder, com.google.cloud.compute.v1.HostRuleOrBuilder> hostRulesBuilder_;
    ...
    public Builder setHostRules(
        int index, com.google.cloud.compute.v1.HostRule value) {
      if (hostRulesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addHostRules(
        com.google.cloud.compute.v1.HostRule.Builder builderForValue) {
      if (hostRulesBuilder_ == null) {
        ensureHostRulesIsMutable();
     ...
     * <code>repeated .google.cloud.compute.v1.HostRule host_rules = 311804832;</code>
     */
    public com.google.cloud.compute.v1.HostRule.Builder getHostRulesBuilder(
        int index) {
    ...
    public com.google.cloud.compute.v1.HostRuleOrBuilder getHostRulesOrBuilder(
        int index) {
      if (hostRulesBuilder_ == null) {
        return hostRules_.get(index);  } else {
    ...
    public com.google.cloud.compute.v1.HostRule.Builder addHostRulesBuilder() {
      return getHostRulesFieldBuilder().addBuilder(
          com.google.cloud.compute.v1.HostRule.getDefaultInstance());
    }
    /**
     * <pre>
     * The list of HostRules to use against the URL.
    ...
    public com.google.cloud.compute.v1.HostRule.Builder addHostRulesBuilder(
        int index) {
      return getHostRulesFieldBuilder().addBuilder(
          index, com.google.cloud.compute.v1.HostRule.getDefaultInstance());
    }
    /**
     * <pre>
     * The list of HostRules to use against the URL.
     ...
     * <code>repeated .google.cloud.compute.v1.HostRule host_rules = 311804832;</code>
     */
    public java.util.List<com.google.cloud.compute.v1.HostRule.Builder> 
         getHostRulesBuilderList() {
      return getHostRulesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.HostRule, com.google.cloud.compute.v1.HostRule.Builder, com.google.cloud.compute.v1.HostRuleOrBuilder> 
        getHostRulesFieldBuilder() {
      if (hostRulesBuilder_ == null) {
        hostRulesBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            com.google.cloud.compute.v1.HostRule, com.google.cloud.compute.v1.HostRule.Builder, com.google.cloud.compute.v1.HostRuleOrBuilder>(
                hostRules_,
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensurePathMatchersIsMutable() {
      if (!((bitField0_ & 0x00000800) != 0)) {
        pathMatchers_ = new java.util.ArrayList<com.google.cloud.compute.v1.PathMatcher>(pathMatchers_);
        bitField0_ |= 0x00000800;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.PathMatcher, com.google.cloud.compute.v1.PathMatcher.Builder, com.google.cloud.compute.v1.PathMatcherOrBuilder> pathMatchersBuilder_;
    ...
    public Builder setPathMatchers(
        int index, com.google.cloud.compute.v1.PathMatcher value) {
      if (pathMatchersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.compute.v1.PathMatcher path_matchers = 271664219;</code>
     */
    public com.google.cloud.compute.v1.PathMatcher.Builder getPathMatchersBuilder(
        int index) {
    ...
    public com.google.cloud.compute.v1.PathMatcherOrBuilder getPathMatchersOrBuilder(
        int index) {
      if (pathMatchersBuilder_ == null) {
        return pathMatchers_.get(index);  } else {
    ...
    public com.google.cloud.compute.v1.PathMatcher.Builder addPathMatchersBuilder() {
      return getPathMatchersFieldBuilder().addBuilder(
          com.google.cloud.compute.v1.PathMatcher.getDefaultInstance());
    }
    /**
     * <pre>
     * The list of named PathMatchers to use against the URL.
    ...
    public com.google.cloud.compute.v1.PathMatcher.Builder addPathMatchersBuilder(
        int index) {
      return getPathMatchersFieldBuilder().addBuilder(
          index, com.google.cloud.compute.v1.PathMatcher.getDefaultInstance());
    }
    /**
     * <pre>
     * The list of named PathMatchers to use against the URL.
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.PathMatcher, com.google.cloud.compute.v1.PathMatcher.Builder, com.google.cloud.compute.v1.PathMatcherOrBuilder> 
        getPathMatchersFieldBuilder() {
      if (pathMatchersBuilder_ == null) {
        pathMatchersBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            com.google.cloud.compute.v1.PathMatcher, com.google.cloud.compute.v1.PathMatcher.Builder, com.google.cloud.compute.v1.PathMatcherOrBuilder>(
                pathMatchers_,
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.UrlMapTest, com.google.cloud.compute.v1.UrlMapTest.Builder, com.google.cloud.compute.v1.UrlMapTestOrBuilder> testsBuilder_;
    ...
    public Builder setTests(
        int index, com.google.cloud.compute.v1.UrlMapTest value) {
      if (testsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addTests(
        com.google.cloud.compute.v1.UrlMapTest.Builder builderForValue) {
      if (testsBuilder_ == null) {
        ensureTestsIsMutable();
     ...
     * <code>repeated .google.cloud.compute.v1.UrlMapTest tests = 110251553;</code>
     */
    public com.google.cloud.compute.v1.UrlMapTest.Builder getTestsBuilder(
        int index) {
    ...
    public com.google.cloud.compute.v1.UrlMapTest.Builder addTestsBuilder() {
      return getTestsFieldBuilder().addBuilder(
          com.google.cloud.compute.v1.UrlMapTest.getDefaultInstance());
    }
    /**
     * <pre>
     * The list of expected URL mapping tests. Request to update this UrlMap will succeed only if all of the test cases pass. You can specify a maximum of 100 tests per UrlMap. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
    ...
    public com.google.cloud.compute.v1.UrlMapTest.Builder addTestsBuilder(
        int index) {
      return getTestsFieldBuilder().addBuilder(
          index, com.google.cloud.compute.v1.UrlMapTest.getDefaultInstance());
    }
    /**
     * <pre>
     * The list of expected URL mapping tests. Request to update this UrlMap will succeed only if all of the test cases pass. You can specify a maximum of 100 tests per UrlMap. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.
     ...
     * <code>repeated .google.cloud.compute.v1.UrlMapTest tests = 110251553;</code>
     */
    public java.util.List<com.google.cloud.compute.v1.UrlMapTest.Builder> 
         getTestsBuilderList() {
      return getTestsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.UrlMapTest, com.google.cloud.compute.v1.UrlMapTest.Builder, com.google.cloud.compute.v1.UrlMapTestOrBuilder> 
        getTestsFieldBuilder() {
      if (testsBuilder_ == null) {
  ...
  private static final com.google.protobuf.Parser<UrlMap>
      PARSER = new com.google.protobuf.AbstractParser<UrlMap>() {
    @java.lang.Override
