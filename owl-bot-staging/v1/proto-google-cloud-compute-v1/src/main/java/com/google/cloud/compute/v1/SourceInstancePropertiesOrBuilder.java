...
public interface SourceInstancePropertiesOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.compute.v1.SavedAttachedDisk> 
      getDisksList();
  /**
   * <pre>
   * An array of disks that are associated with the instances that are created from this machine image.
   ...
   * <code>repeated .google.cloud.compute.v1.SavedAttachedDisk disks = 95594102;</code>
   */
  com.google.cloud.compute.v1.SavedAttachedDiskOrBuilder getDisksOrBuilder(
      int index);
