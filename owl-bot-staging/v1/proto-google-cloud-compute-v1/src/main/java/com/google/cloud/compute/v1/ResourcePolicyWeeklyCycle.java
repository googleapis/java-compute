        ...
        switch (tag) {
          ...
          case 2062974674: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              dayOfWeeks_ = new java.util.ArrayList<com.google.cloud.compute.v1.ResourcePolicyWeeklyCycleDayOfWeek>();
              mutable_bitField0_ |= 0x00000001;
            }
            dayOfWeeks_.add(
                input.readMessage(com.google.cloud.compute.v1.ResourcePolicyWeeklyCycleDayOfWeek.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.compute.v1.ResourcePolicyWeeklyCycle) e.getUnfinishedMessage();
